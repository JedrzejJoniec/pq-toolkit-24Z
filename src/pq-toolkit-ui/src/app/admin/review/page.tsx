                        ...
                        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
                            <div
                                ...
                                <div className="flex justify-between items-center mb-4">
                                    <h3 className="text-2xl font-bold dark:text-white">{expandedExperiment} Results</h3>
                                    <button
                                ...
                                <div
                                    className="overflow-y-auto max-h-[500px] scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-gray-600 scrollbar-track-gray-100 dark:scrollbar-track-gray-700 space-y-8 w-full max-w-[800px] mx-auto"
                                >
